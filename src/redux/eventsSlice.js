...
const removeDoubles = (events) => {
  return _.uniqBy(events, '_id');
}
...
export const addEventAsync = createAsyncThunk(
  ...
  async (event) => {
    ...
    return {...event, _id:response.data.insertedId};
  }
);
//remove event by id
...
export const eventsSlice = createSlice({
  ...
  reducers: {
    addEvent: (state, action) => {
      ...
      state.events=removeDoubles(state.events);
    },
...
export const {addEvent, removeEventById} = eventsSlice.actions;
